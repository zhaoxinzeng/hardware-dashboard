          ...
          <tbody className="divide-y divide-border-subtle/30">
            {frameworks.map((fw) => (
              <tr key={fw} className="hover:bg-blue-50/30 transition-colors">
                <td className="p-4 font-medium text-gray-900">{fw}</td>
                {hardwareVendors.map((vendor) => (
                  <td key={vendor} className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      {docLinks[fw]?.[vendor] ? (
                        <a
                          href={docLinks[fw][vendor]}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1 px-2 py-1 rounded bg-blue-50 text-blue-700 border border-blue-200 text-xs font-medium hover:bg-blue-100 transition-colors"
                        >
                          查看文档
                        </a>
                      ) : null}
